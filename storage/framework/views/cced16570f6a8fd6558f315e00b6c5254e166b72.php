...
<?php $__env->startSection('main-content'); ?>
  ...
  <!-- Fila de datos.
  <img src="<?php echo e(asset ("/bower_components/admin-lte/dist/img/logo.png")); ?>">
  -->
  ...
  <div class="box">
    <div class="box-header">
      <div class="box-body">
        <div class="col-sm-2">
          <img class="pull-left" height="100%" width="100%" src="<?php echo e(asset ("/bower_components/admin-lte/dist/img/logo.png")); ?>">
        </div>
        ...
        <div class="col-sm-2" id="imgHotel">
          <input id="linkd" name="linkd" type="hidden" value="<?php echo e(asset ("")); ?>">

    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action="<?php echo e(url('/password/reset')); ?>" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="<?php echo e(trans('message.retrypepassword')); ?>" name="password_confirmation"/>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>

                <div class="row">
                    <div class="col-xs-5">
                      <button type="submit" class="btn btn-primary btn-block btn-flat"><?php echo e(trans('message.passwordresettwo')); ?></button>
                    </div><!-- /.col -->
                    <div class="col-xs-2">
                    </div><!-- /.col -->
                    <div class="col-xs-5">
                      <a class="btn btn-danger btn-block btn-flat" href="<?php echo e(url('/login')); ?>"><?php echo e(trans('message.login')); ?></a><br>
                    </div><!-- /.col -->
                </div>
            </form>
        </div><!-- /.login-box-body -->

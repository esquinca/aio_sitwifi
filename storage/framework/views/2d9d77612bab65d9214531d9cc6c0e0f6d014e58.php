        ...
        <div class="col-md-8">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#change" data-toggle="tab"><?php echo e(trans('message.changePassword')); ?></a></li>
            </ul>
            <div class="tab-content">
              ...
              <!-- /.tab-pane -->
                ...
                <div class="tab-pane" id="change">
                  <?php echo Form::open(['action' => 'profilesController@updatetwo', 'url' => '/upd_password', 'method' => 'post', 'id' => 'formPerfilpass', 'class' => 'form-horizontal' ]); ?>

                    <div class="form-group" style="display:none;">
                      <label for="inputEmailcorreo" class="col-sm-4 control-label"><?php echo e(trans('message.emailaddress')); ?></label>
                      <div class="col-sm-8">
                        <input type="email" class="form-control" id="inputEmailcorreo" name="inputEmailcorreo" placeholder="<?php echo e(trans('message.emailaddress')); ?>" maxlength="30" value='<?php if(Auth::check()): ?><?php echo e(Auth::user()->email); ?><?php endif; ?>' readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputnpass" class="col-sm-4 control-label"><?php echo e(trans('message.newPassword')); ?><span style="color: red;">*</span></label>
                      <div class="col-sm-8">
                        <input type="password" class="form-control" id="inputnpass" name="inputnpass" placeholder="<?php echo e(trans('message.newPassword')); ?>." maxlength='6' minlength='5'>
                        <div class="checkbox">
                          <label><input type="checkbox" name="show" id="show"> <?php echo e(trans('message.showpass')); ?></label>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-sm-offset-2 col-sm-10">
                        <button id="update_pass" name="update_pass" type="button" class="btn btn-warning"><span class="fa fa-pencil-square-o" style="margin-right: 4px;"></span><?php echo e(trans('message.actualizar')); ?></button>
                      </div>
                    </div>
                  <?php echo Form::close(); ?>

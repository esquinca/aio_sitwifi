                ...
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="width: 570px; margin: 0 auto; padding: 0; -premailer-width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF;">
                  <tr>
                      <td style="padding: 35px;">
                        <h1 style="margin-top: 0; color: #2F3133;  font-size: 19px;  font-weight: bold;  text-align: left;"><?php echo e(trans('correolang.title')); ?></h1>
                        <p style="margin-top: 0; color: #74787E; line-height: 1.5em; font-size: 12px; text-align: left;"><?php echo e(trans('correolang.message_one')); ?> <strong><?php echo e(trans('correolang.message_two')); ?></strong></p>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td>
                                          ...
                                          <a href="<?php echo e(url('password/reset/'.$token)); ?>" style="background-color: #3869D4;
                                          ...
                                          ><?php echo e(trans('correolang.message_passwordreset')); ?></a>

                                          <!--<a href="<?php echo e(url('password/reset/'.$token)); ?>" ><?php echo e(url('password/reset/'.$token)); ?>Reset your password</a>-->
                                        </td>
                                      </tr>
                                    </table>
                                  </td>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;"><?php echo e(trans('correolang.message_three')); ?></p>
                        ...
                        <p style="margin-top: 0;
                                  ...
                                  text-align: left;
                                  font-size: 12px;
                                  text-align: left;"><?php echo e(trans('correolang.message_four')); ?>


                        <br><?php echo e(trans('correolang.message_empresa')); ?></p>
                          ...
                          <tr>
                            <td>
                              <p style="margin-top: 0;
                                  ...
                                  line-height: 1.5em;
                                  text-align: left;
                                  font-size: 12px;"><?php echo e(trans('correolang.message_five')); ?></p>
                              <p style="font-size: 12px;">
                              <a href="<?php echo e(url('password/reset/'.$token)); ?>"><?php echo e(url('password/reset/'.$token)); ?></a></p>
                            </td>
                          </tr>
                        </table>
                  ...
                  <tr>
                    <td align="center" style="padding: 35px;">
                      <p style="margin-top: 0;
                          ...
                          font-size: 12px;
                          line-height: 1.5em;
                          text-align: center;">&copy; 2017 <?php echo e(trans('correolang.message_empresa')); ?>. <?php echo e(trans('correolang.message_nine')); ?>.</p>
                      <p  style="margin-top: 0;
                          color: #74787E;
                          font-size: 12px;
                          line-height: 1.5em;
                          text-align: center;">
                        <?php echo e(trans('correolang.message_six')); ?>

                        <br><?php echo e(trans('correolang.message_seven')); ?>

                        <br><?php echo e(trans('correolang.message_eight')); ?>
